...
SELECT Event, Season, NUll as Round, Place, Name, Year, Team, Mark as Mark, null as TIME_DETAIL, null as REACTION_TIME, NULL AS QUALIFIER, "Flight(pl)" as "Section(pl)", Wind, Score from m_TJ_final_2022 UNION ALL
...
SELECT EVENT, SEASON, Null as Round, Place, Name, Year, Team, Mark as Mark, null as TIME_DETAIL, null as REACTION_TIME, NULL AS QUALIFIER, "Flight(pl)" as "Section(pl)", null as Wind, Score from m_HT_final_2022
